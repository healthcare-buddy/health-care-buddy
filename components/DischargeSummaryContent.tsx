...
// import { Upload, FileText, X, Loader2, CheckCircle, Eye } from "lucide-react";
...
//                 <div
//                   key={summary.id}
//                   className="flex max-sm:flex-col items-center justify-between p-4 border rounded-lg"
//                 >
//                   <div className="flex items-center space-x-3">
//                     <div>
//                       <p className="font-medium text-sm flex items-center my-2 gap-2">
...
//                     </div>
//                   </div>
//                   <div className="flex items-center space-x-2 max-sm:w-full max-sm:mt-5">
